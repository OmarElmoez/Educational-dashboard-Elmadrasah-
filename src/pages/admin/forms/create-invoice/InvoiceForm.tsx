...
//   isCopy?: boolean;
//   id?: string;
//   currentInvoice?: TCreateInvoiceFormDataForGet | null;
// };
// // ------------------------------------------------------------------------
...
//   useEffect(() => {
//     if ((isCopy || isEdit) && currentInvoice) {
//       console.log("currentInvoice", currentInvoice);

//       reset(currentInvoice);
//     }
//   }, [currentInvoice, isCopy, isEdit, reset]);
...
//       const validTaxRate = Number(salesTaxRate);
      
//       let total = validSubtotal;
//       let salesTax = 0;
      
//       console.log("***** total, salesTax, subtotal", total, salesTax, subtotal);
//       switch (treatmentType) {
//         case "Tax Exclusive":
//           // salesTax = (salesTaxRate / 100) * subtotal;
//           // total = subtotal + salesTax;
//           // subtotal;
//           salesTax = (validTaxRate / 100) * validSubtotal;
//           total = validSubtotal + salesTax;
          
//           console.log(
//             " 111 total, salesTax, subtotal",
//             total,
//             salesTax,
//             subtotal
//           );
...
//       // const tax_count_num = Number(tax_count)
//       const { total, salesTax, subtotal } = calculateTotal(
//         parseFloat(sub_total.toString()),
//         parseFloat(tax_count)
//       );

//       console.log(" parseFloat(sub_total.toString()) parseFloat(tax_count)",  parseFloat(sub_total.toString()),tax_count,
//       parseFloat(tax_count));
//       console.log("total", total.toFixed(2));
//       console.log("sales_tax_total", salesTax.toFixed(2));
